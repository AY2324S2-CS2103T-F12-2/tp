...
with(this){return _c('h3',{attrs:{"id":"proposed-link-webpage-to-articles"}},[_v("[Proposed] Link Webpage to Articles"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-link-webpage-to-articles","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed link feature is enabled by filling up "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("link")]),_v(" attribute of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Article")]),_v(" class when adding an article. This feature creates a link button on the UI of each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Article")]),_v(" that opens up a web browser and directs the user to the webpage of where the actual article is uploaded.\nSince the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Articlebook")]),_v(" does not store the whole content of the articles, users will be able to read the articles using this feature.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"design-considerables"}},[_v("Design Considerables"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#design-considerables","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Make sure the link button on UI correctly directs the user the exact webpage of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Article")]),_v(".")]),_v(" "),_c('li',[_v("Make sure the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("link")]),_v(" saved on "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Article")]),_v(" objects are saved without parsing errors.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 12:57:25 GMT+8]")])])])}
}];
